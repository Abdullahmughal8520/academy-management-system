...
<style>
/* =========================================================
   EDIT FEE STRUCTURE — EXAMS THEME
   ========================================================= */
...
<div class="fee-structure-form-page">
    ...
    <div class="fsf-header">
        ...
        <p class="fsf-subtitle">
            Update the fee structure and its settings.
        </p>
    ...
    <div class="fsf-card">
        ...
        <form action="{{ route('fee-structures.update', $feeStructure) }}"
              method="POST">
                        ...
                        <select name="academy_class_id"
                            ...
                            @foreach($classes as $class)
                                ...
                                <option value="{{ $class->id }}"
                                    {{ old('academy_class_id', $feeStructure->academy_class_id) == $class->id ? 'selected' : '' }}>
                        ...
                        <select name="group_id"
                            ...
                            @foreach($groups as $group)
                                ...
                                <option value="{{ $group->id }}"
                                    {{ old('group_id', $feeStructure->group_id) == $group->id ? 'selected' : '' }}>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number"
                               ...
                               step="0.01"
                               min="0"
                               value="{{ old('exam_fee', $feeStructure->exam_fee) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number"
                               ...
                               step="0.01"
                               min="0"
                               value="{{ old('default_discount', $feeStructure->default_discount) }}">
                        ...
                        <input type="date"
                               ...
                               value="{{ old(
                                   ...
                                   $feeStructure->effective_from
                                       ? $feeStructure->effective_from->format('Y-m-d')
                                       : ''
                               ) }}">
            ...
            <div class="fsf-section">
                ...
                <div class="fsf-checkbox-wrapper">
                    ...
                    <input type="checkbox"
                           ...
                           class="fsf-checkbox"
                           id="status"
                           {{ old('status', $feeStructure->status) ? 'checked' : '' }}>

                    <label for="status"
                           class="fsf-checkbox-label">

                        Keep this fee structure active
