...
/* =========================================================
   EDIT STUDENT — SAME ADMIN DASHBOARD THEME
   ========================================================= */
...
/* =========================================================
   UPDATE BUTTON
   SAME ADMIN DASHBOARD BUTTON STYLE
   ========================================================= */
        ...
        <div class="form-section">
            ...
            <div class="section-heading">
                ...
                <div>
                    ...
                    <p class="section-subtitle">
                        Update class and group assignment
                    </p>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    >
                        ...
                        @foreach ($classes as $class)
                            ...
                            <option
                                value="{{ $class->id }}"
                                {{ old('academy_class_id', $student->academy_class_id) == $class->id ? 'selected' : '' }}
                            >
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-hint">
                        Groups are filtered according to the selected class.
                    </div>
        ...
        <div class="form-section">
            ...
            @if ($student->user_id)
                ...
                <div class="account-info mt-3">
                    ...
                    <span>
                        This student has a login account.
                    </span>
            ...
            @else
                ...
                <div class="account-info mt-3">
                    ...
                    <span>
                        ...
                        You can create one from the Students page.
                    </span>
...
const classSelect =
    document.getElementById('academy_class_id');
