...
<style>
    /* =========================================================
       EDIT SCHEDULE — DARK ADMIN THEME
       ========================================================= */

    body:has(.edit-schedule-page) .main-wrapper,
    body:has(.edit-schedule-page) .page-content {
    ...
    .edit-schedule-page .alert-danger {
    ...
    .edit-schedule-page .alert-danger strong {
        color: #f8fafc;
    }

    .edit-schedule-page .alert-danger ul {
        color: #fb7185;
    }
    ...
    .edit-schedule-page .form-control,
    .edit-schedule-page .form-select {
        min-height: 42px;
    ...
    .edit-schedule-page .form-control:hover,
    .edit-schedule-page .form-select:hover {
        border-color: #344760 !important;

        background-color: #101b2b !important;
    }

    .edit-schedule-page .form-control:focus,
    .edit-schedule-page .form-select:focus {
    ...
    .edit-schedule-page .form-control::placeholder {
    ...
    .edit-schedule-page .form-select option {
        background: #0f1826;
        color: #dbe4f2;
    }
    ...
    .edit-schedule-page input[type="time"]::-webkit-calendar-picker-indicator {
        filter:
            invert(75%)
            sepia(15%)
            saturate(500%)
...
<div class="edit-schedule-page">
    ...
    <div class="form-page-header d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <p>
                Update the academy class schedule and timing details.
            </p>
                    ...
                    <div class="col-md-12">
                        ...
                        >
                            ...
                            @foreach ($assignments as $assignment)
                                ...
                                <option
                                    value="{{ $assignment->id }}"
                                    {{ old('teacher_assignment_id', $schedule->teacher_assignment_id) == $assignment->id ? 'selected' : '' }}
                                >
                        ...
                        <div class="form-hint">
                            Choose the teacher, subject, class and group combination.
                        </div>
            ...
            <div class="form-section">
                ...
                <div class="section-heading">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">
                            Update when and where the class will take place
                        </p>
                ...
                <div class="info-box mt-3">
                    ...
                    Review the teacher assignment, day and timing before
                    saving the schedule changes.
