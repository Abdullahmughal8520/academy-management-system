...
<style>
    /* =========================================================
       CLASSES PAGE — DARK ADMIN THEME
       ========================================================= */

    body:has(.classes-page){
        background:#080e17 !important;
    }

    body:has(.classes-page) .main-wrapper{
        background:#080e17 !important;
    }

    body:has(.classes-page) .page-content{
        background:#080e17 !important;
    ...
    /* =========================================================
       DELETE MODAL — SAME AS TEACHERS / STUDENTS / COURSES
       ========================================================= */

    body:has(.classes-page) .delete-modal-overlay{
    ...
    body:has(.classes-page) .delete-modal-overlay.show{
    ...
    body:has(.classes-page) .delete-modal{
    ...
    body:has(.classes-page) .delete-modal::before{
        content:"";
    ...
    body:has(.classes-page) .delete-modal-icon{
    ...
    body:has(.classes-page) .delete-modal h3{
    ...
    body:has(.classes-page) .delete-modal p{
        color:#718096 !important;
    ...
    body:has(.classes-page) .delete-modal-actions{
        display:flex;
    ...
    body:has(.classes-page) .modal-cancel-btn{
        background:#0d1725 !important;
    ...
    body:has(.classes-page) .modal-cancel-btn:hover{
    ...
    body:has(.classes-page) .modal-delete-btn{
        position:relative;
    ...
    body:has(.classes-page) .modal-delete-btn::before{
        content:"";
    ...
    body:has(.classes-page) .modal-delete-btn:hover{
        color:#fff !important;
    ...
    body:has(.classes-page) .modal-delete-btn:hover::before{
        left:140%;
    }
...
<div class="classes-page">
    ...
    <div class="classes-header">
        ...
        <div>
            ...
            <p class="classes-subtitle">
                Manage academy classes and their details.
            </p>
        </div>
    ...
    <div class="class-table-card">
        ...
        <div class="class-table-wrapper">
            ...
            <table class="table class-table align-middle">
